package com.faster.aichat.data
...
data class AppSettings(
    ...
    val systemPrompt: String = "你是一个ai助手，输出时避免使用markdown，保持亲切语气和善"
)
...
class PreferencesRepository(private val context: Context) {
    ...
    val settingsFlow: Flow<AppSettings> = context.dataStore.data.map { prefs ->
        AppSettings(
            ...
            systemPrompt = prefs[KEY_SYSTEM_PROMPT] ?: "你是一个ai助手，输出时避免使用markdown，保持亲切语气和善"
        )
    }
